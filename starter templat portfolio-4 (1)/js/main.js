...
(() => {
  ...
  tabsContainer.addEventListener("click", (event) => {
    // if event.target contains 'tap-item' class and not contains 'active' class
    if (
...
(() => {
  ...
  //set width of a slider container
